function navbar() {
  return `
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark-blue fixed-top">
      <div class="container-fluid pe-5 ps-5 d-flex justify-content-center align-items-center">
        <a class="navbar-brand" href="#"><img src="../../assets/Logo-senat.png" width="100px" alt="photo" /></a>
        <button
