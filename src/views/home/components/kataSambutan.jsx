        ...
        <div className="lg:w-1/2 w-[80%]">
          ...
          <AppearFadeIn delay="0.5">
            <p className="mt-3 text-[10.5px] text-justify indent-10 lg:text-[16px]">
              ...
              melalui berbagai kegiatan dan program serta aspirasi yang
              diberikan. Sebagai Ketua Umum, saya merasa terhormat bisa memimpin
              organisasi ini bersama tim yang berdedikasi dan profesional. Kami
              berkomitmen untuk terus berinovasi dan memperkuat peran kami dalam
              membantu menciptakan perubahan positif bagi lingkungan sekitar.
              Melalui platform ini yang dibuat dengan berkolaborasi di salah
              satu UKM yaitu UKM Proggramming, kami berharap dapat lebih dekat
              dengan Anda, berbagi informasi seputar program kerja, kegiatan,
              serta Informasi Kegiatan Kemahasiswaan yang kami lakukan.
              Partisipasi dan dukungan Anda sangat berharga bagi kami dalam
              mewujudkan visi dan misi organisasi. Terima kasih atas kepercayaan
              dan dukungan yang telah diberikan. Mari bersama-sama kita terus
              bergerak maju, menginspirasi, dan memberikan dampak positif bagi
              masyarakat.
            </p>
