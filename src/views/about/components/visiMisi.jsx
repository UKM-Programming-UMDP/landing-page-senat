        ...
        {listMisi.map((misi, index) => (
          <AppearFadeLeft delay={index * 0.1} key={index}>
            <div className="flex items-center gap-3 text-[9px] md:gap-7 md:text-sm lg:text-lg">
              ...
              <span className="flex items-center w-full px-3 py-1 text-left border-2 rounded-full border-dark-blue text-[8px] md:min-h-[4.5rem] md:px-8 md:py-2 md:text-sm lg:text-lg">
                {misi}
              </span>
            </div>
          </AppearFadeLeft>
