    ...
    <>
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold p-4 sm:p-12 text-white mx-4 sm:mx-10 mt-10">
            SENAT MAHASISWA
          </h1>
          <div className="flex items-center justify-center text-white md:px-32 text-left px-4 mt-10">
